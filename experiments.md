...
| 2026-05-30 | 2a80ad7 | 修复 LGBM 时间切分：训练特征泄漏 + 正样本稀疏 + _build_source_for | — | ✅ | **0.012** ❌ | 时间切分修复后仍不如纯召回 0.01604，LGBM 全量推理不适合当前架构 |
| 2026-05-30 | d880504 | 添加 UserCF 召回（倒排索引，4 路召回） | 0.011777 (召回↓) / **0.019696** (精排🔥) | — | — | UserCF 降低召回 MAP 但精排创历史最高 0.019696 |
| 2026-05-30 | da90e0b | LGBM 改用 27 周标签（与召回同期）+ 5 路召回 | — | ✅ | **0.009** ❌ | 27 周标签方案全量仍失败，5 路召回 + LGBM 全量无法超越纯召回 0.01604 |
